...
namespace MAD.API.Procore.Requests {
	public class ListChecklistsRequest : ProcoreRequest<IEnumerable<ArrayOfChecklistGroupedByTemplate>> {
		...
		/// </summary>
		[RequestParameter("filters[inspection_type_id]")]
		...
		/// </summary>
		[RequestParameter("filters[point_of_contact_id]")]
		...
		/// </summary>
		[RequestParameter("filters[inspector_id]")]
		...
		/// </summary>
		[RequestParameter("filters[list_template_id]")]
		...
		/// </summary>
		[RequestParameter("filters[location_id]")]
		...
		/// </summary>
		[RequestParameter("filters[spec_section_id]")]
		public string[]? SpecSectionId { get; set; }


		/// <summary>
		/// Array of Vendor IDs. Return item(s) where the specified Vendor IDs are the responsible contractor.
		/// </summary>
		[RequestParameter("filters[responsible_contractor_id]")]
		...
		/// </summary>
		[RequestParameter("filters[status]")]
		...
		/// Trade ID
		/// </summary>
		[RequestParameter("filters[trade_id]")]
		...
		/// Search query
		/// </summary>
		[RequestParameter("filters[search]")]
		...
		/// </summary>
		[RequestParameter("filters[due_at]")]
		...
		/// </summary>
		[RequestParameter("filters[created_at]")]
