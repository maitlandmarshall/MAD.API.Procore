...
namespace MAD.API.Procore.Requests {
	public class ListProjectPeopleRequest : ProcoreRequest<ArrayOfProjectPeople> {
		...
		/// </summary>
		[RequestParameter("filters[is_employee]")]
		...
		/// </summary>
		[RequestParameter("filters[reference_users_only]")]
		public bool? ReferenceUsersOnly { get; set; }
		...
		/// </summary>
		[RequestParameter("filters[include_company_people]")]
		public bool? IncludeCompanyPeople { get; set; }
