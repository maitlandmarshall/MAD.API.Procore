...
namespace MAD.API.Procore.Requests {
	public class ListIncidentsRequest : ProcoreRequest<IEnumerable<IncidentCompact>> {
		...
		/// </summary>
		[RequestParameter("filters[event_date]")]
		...
		/// </summary>
		[RequestParameter("filters[contributing_behavior_id]")]
		public string[]? ContributingBehaviorId { get; set; }


		/// <summary>
		/// Return item(s) with a specific Contributing Condition ID
		/// </summary>
		[RequestParameter("filters[contributing_condition_id]")]
		public string[]? ContributingConditionId { get; set; }


		/// <summary>
		/// Return item(s) with a specific Hazard ID
		/// </summary>
		[RequestParameter("filters[hazard_id]")]
		...
		/// </summary>
		[RequestParameter("filters[time_unknown]")]
		...
		/// </summary>
		[RequestParameter("filters[recordable]")]
		...
		/// </summary>
		[RequestParameter("filters[query]")]
