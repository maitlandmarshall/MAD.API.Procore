...
namespace MAD.API.Procore.Endpoints.Meetings.Models {
	public class MeetingMeetingCategoryMeetingTopic {
		...
		/// Meeting category
		/// </summary>
		[JsonProperty("meeting_category")]	public  MeetingTopicMeetingCategory MeetingCategory { get ; set; }

		/// <summary>
		/// Meeting topic assignments
		/// </summary>
		[JsonProperty("assignments")]	public  List<MeetingTopicAssignment> Assignments { get ; set; }

		/// <summary>
		/// Meeting topic attachments
		/// </summary>
		[JsonProperty("attachments")]	public  List<MeetingTopicAttachment> Attachments { get ; set; }
	}
}
