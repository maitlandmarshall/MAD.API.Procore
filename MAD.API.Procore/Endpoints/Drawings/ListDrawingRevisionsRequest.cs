...
{
	public class ListDrawingRevisionsRequest : ProcorePaginatedRequest<IEnumerable<DrawingRevision>>
	{

		public override string Resource { get => $"/projects/{this.ProjectId}/drawing_revisions"; }
