...
namespace MAD.API.Procore.Endpoints.Forms {
	public class ListFormsOnAProjectRequest : ProcorePaginatedRequest<IEnumerable<ListFormsOnAProjectRequestResult>> {

		public override string Resource { get => $"/projects/{this.ProjectId}/forms";}
