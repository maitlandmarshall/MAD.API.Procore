...
namespace MAD.API.Procore.Endpoints.CompanyUsers.Models {
	public class User {
		...
		/// </summary>
		[JsonProperty("default_permission_template_id")]	public  long? DefaultPermissionTemplateId { get ; set; }

		[JsonProperty("permission_template")]	public  PermissionTemplate PermissionTemplate { get ; set; }

		/// <summary>
		/// User Company Permission Template id
		/// </summary>
		[JsonProperty("company_permission_template_id")]	public  long? CompanyPermissionTemplateId { get ; set; }
	}
}
