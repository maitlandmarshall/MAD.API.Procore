...
namespace MAD.API.Procore.Endpoints.Submittals.Models {
	public class ShowSubmittalRequestResultApprover {
		...
		[JsonProperty("response")]	public  ShowSubmittalRequestResultApproverResponse Response { get ; set; }
		...
		[JsonProperty("user")]	public  ShowSubmittalRequestResultApproverUser User { get ; set; }

		/// <summary>
		/// Attachments
		/// </summary>
		[JsonProperty("attachments")]	public  List<ShowSubmittalRequestResultApproverAttachment> Attachments { get ; set; }
