...
namespace MAD.API.Procore.Endpoints.CompanyVendors {
	public class ListCompanyVendorsRequest : ProcorePaginatedRequest<IEnumerable<CompanyVendor>> {
		...
		/// </summary>
		[RequestParameter("filters[standard_cost_code_id][]")]	public  int[] StandardCostCodeId { get ; set; }
		...
		/// </summary>
		[RequestParameter("filters[parent_id][]")]	public  int[] ParentId { get ; set; }
